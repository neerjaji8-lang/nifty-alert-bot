...
def is_market_open():
    ...
    if not (start <= now <= end):
        return False
    holidays = ["2025-01-26", "2025-03-14", "2025-04-18", "2025-05-01", "2025-08-15", "2025-10-02", "2025-10-24", "2025-12-25"]
...
# ====== DUMMY DATA FETCH (replace with API) ======
...
def main():
    if not is_market_open():
        send_to_telegram("💤 *Market Closed*\nNo updates — NSE timings 09:15–15:30 IST")
        return

    spot_price = 25597.65  # replace with live NSE API later
